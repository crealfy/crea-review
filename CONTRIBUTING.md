# Contributing to crea-review

Thank you for your interest in contributing to crea-review! This document provides guidelines for contributing to the project.
...
import (
    ...
    "github.com/crealfy/crea-review/pkg/adapter"  // local
)
```
...
By contributing to crea-review, you agree that your contributions will be licensed under the [BSD 3-Clause License](LICENSE).
