#!/bin/bash
#
# crea-review Install Script
#
# Usage:
#   curl -fsSL https://raw.githubusercontent.com/crealfy/crea-review/master/install.sh | bash
#   curl -fsSL https://raw.githubusercontent.com/crealfy/crea-review/master/install.sh | bash -s -- --nightly
#   curl -fsSL https://raw.githubusercontent.com/crealfy/crea-review/master/install.sh | bash -s -- -v v1.2.3
#

set -euo pipefail

REPO="crealfy/crea-review"
...
# Kill running processes to prevent "Text file busy"
...
crea-review requires WSL2 (Windows Subsystem for Linux) on Windows.

To install via WSL:
  1. Install WSL2: wsl --install (in PowerShell as Admin)
  2. Restart your computer
  3. Run this script inside WSL: wsl -e bash -c \"curl -fsSL https://raw.githubusercontent.com/crealfy/crea-review/master/install.sh | bash\"

Or use the PowerShell installer:
  irm https://raw.githubusercontent.com/crealfy/crea-review/master/install.ps1 | iex

Documentation: https://valksor.com/docs/crea-review"
            ;;
        *)
...
verify_minisign() {
    ...
    if [[ -z "$MINISIGN_PUBLIC_KEY" ]]; then
        info "Minisign public key not configured - skipping signature verification"
        return 0
    fi
...
main() {
    echo ""
    echo "                                _            "
    echo "   ___ _ __ ___  __ _      _ __(_)_ __   ___ "
    echo "  / __| '__/ _ \\/ _\` |____| '_ \\| | '_ \\ / _ \\"
    echo " | (__| | |  __/ (_| |____| |_) | | |_) |  __/"
    echo "  \\___|_|  \\___|\\__,_|    | .__/|_| .__/ \\___|"
    echo "                         |_|    |_|          "
    echo ""
