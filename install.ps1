...
<#
.SYNOPSIS
    crea-review Windows Install Script - Installs crea-review inside WSL

.DESCRIPTION
    This script verifies WSL2 is configured, then installs crea-review inside your
...
.EXAMPLE
    irm https://raw.githubusercontent.com/crealfy/crea-review/master/install.ps1 | iex
...
.LINK
    https://github.com/crealfy/crea-review
    https://valksor.com/docs/crea-review
#>
...
# Script constants
$InstallScriptUrl = "https://raw.githubusercontent.com/crealfy/crea-review/master/install.sh"
$DocsUrl = "https://valksor.com/docs/crea-review"
...
function Show-Banner {
    ...
    Write-Host "   ___ _ __ ___  __ _      _ __(_)_ __   ___ " -ForegroundColor Cyan
    Write-Host "  / __| '__/ _ \/ _` |____| '_ \| | '_ \ / _ \" -ForegroundColor Cyan
    Write-Host " | (__| | |  __/ (_| |____| |_) | | |_) |  __/" -ForegroundColor Cyan
    Write-Host "  \___|_|  \___|\__,_|    | .__/|_| .__/ \___|" -ForegroundColor Cyan
    Write-Host "                         |_|    |_|          " -ForegroundColor Cyan
    Write-Host ""
    Write-Host "  AI-Powered Code Review - Windows Installer"
    Write-Host ""
}
...
function Install-CreaPipe {
    ...
    Write-ColorOutput "Installing crea-review inside WSL..." -Type "Info"
    Write-Host ""
...
function Test-Installation {
    ...
    $result = wsl -e creareview version 2>&1
    if ($LASTEXITCODE -eq 0) {
        ...
        Write-Host "Try: wsl --shutdown && wsl -e creareview version"
        return $false
    }
}
...
function Show-NextSteps {
    ...
    Write-Host ""
    Write-Host "  3. Start using crea-review:"
    Write-Host "     creareview --help"
    Write-Host ""
...
function Main {
    ...
    # Install crea-review
    Install-CreaPipe -Distro $distro
