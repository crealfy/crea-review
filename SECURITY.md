...
If you discover a security vulnerability in crea-review, please **do not** create a public issue.

Instead, send your report privately:

1. **GitHub Security Advisory** (Recommended):
   - Visit https://github.com/crealfy/crea-review/security/advisories
...
2. **Email**:
   ...
   - Include "SECURITY: crea-review" in the subject line
...
- **Secure secrets**: Store API keys in environment variables or `.crea-review/.env` (never commit secrets)
...
- **GitHub Security Advisories**: https://github.com/crealfy/crea-review/security/advisories

Thank you for helping keep crea-review secure!
